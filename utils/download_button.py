...
# def download_data(df:pd.DataFrame,download_type:str, file_name:str):
#     if download_type == "csv":
#         csv = df.to_csv(index=False)
#         b64 = base64.b64encode(csv.encode())
#         href = f'<a href="data:application/octet-stream;base64,{b64.decode()}" download="{file_name}.csv">Download csv file</a>'  
#     else:
#         val = to_excel(df)
#         b64 = base64.b64encode(val)  
#         href = f'<a href="data:application/octet-stream;base64,{b64.decode()}" download="{file_name}.xlsx">Download excel file</a>'  
#     return href    
